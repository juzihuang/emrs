...
public class TemperatureRecordAction extends BaseAction{
    ...
    public String addTemperatureRecord(){
        ...
        String  time_hour_2_temperature=this.getJsonObject("time_hour_2_temperature").toString();
        String  time_hour_6_temperature=this.getJsonObject("time_hour_6_temperature").toString();
        String  time_hour_10_temperature=this.getJsonObject("time_hour_10_temperature").toString();
        String  time_hour_14_temperature=this.getJsonObject("time_hour_14_temperature").toString();
        String  time_hour_18_temperature=this.getJsonObject("time_hour_18_temperature").toString();
        String  time_hour_22_temperature=this.getJsonObject("time_hour_22_temperature").toString();
        String  time_hour_2_breath=this.getJsonObject("time_hour_2_breath").toString();
        String  time_hour_6_breath=this.getJsonObject("time_hour_6_breath").toString();
        String  time_hour_10_breath=this.getJsonObject("time_hour_10_breath").toString();
        String  time_hour_14_breath=this.getJsonObject("time_hour_14_breath").toString();
        String  time_hour_18_breath=this.getJsonObject("time_hour_18_breath").toString();
        String  time_hour_22_breath=this.getJsonObject("time_hour_22_breath").toString();
   ...
   //     String  breath=this.getJsonObject("breath").toString();
        ...
        temperatureRecord.setTime_hour_2_breath(Float.parseFloat(time_hour_2_breath));
        temperatureRecord.setTime_hour_6_breath(Float.parseFloat(time_hour_6_breath));
        temperatureRecord.setTime_hour_10_breath(Float.parseFloat(time_hour_10_breath));
        temperatureRecord.setTime_hour_14_breath(Float.parseFloat(time_hour_14_breath));
        temperatureRecord.setTime_hour_18_breath(Float.parseFloat(time_hour_18_breath));
        temperatureRecord.setTime_hour_22_breath(Float.parseFloat(time_hour_22_breath));
        temperatureRecord.setTime_hour_2_temperature(Float.parseFloat(time_hour_2_temperature));
        temperatureRecord.setTime_hour_6_temperature(Float.parseFloat(time_hour_6_temperature));
        temperatureRecord.setTime_hour_10_temperature(Float.parseFloat(time_hour_10_temperature));
        temperatureRecord.setTime_hour_14_temperature(Float.parseFloat(time_hour_14_temperature));
        temperatureRecord.setTime_hour_18_temperature(Float.parseFloat(time_hour_18_temperature));
        temperatureRecord.setTime_hour_22_temperature(Float.parseFloat(time_hour_22_temperature));
    ...
    public String getTemperatureRecord() throws Exception {
        ...
        jsonObject.put("time_hour_2_breath", temperatureRecord.getTime_hour_2_breath());
        jsonObject.put("time_hour_6_breath", temperatureRecord.getTime_hour_6_breath());
        jsonObject.put("time_hour_10_breath", temperatureRecord.getTime_hour_10_breath());
        jsonObject.put("time_hour_14_breath", temperatureRecord.getTime_hour_14_breath());
        jsonObject.put("time_hour_18_breath", temperatureRecord.getTime_hour_18_breath());
        jsonObject.put("time_hour_22_breath", temperatureRecord.getTime_hour_22_breath());
        jsonObject.put("time_hour_2_temperature", temperatureRecord.getTime_hour_2_temperature());
        jsonObject.put("time_hour_6_temperature", temperatureRecord.getTime_hour_6_temperature());
        jsonObject.put("time_hour_10_temperature", temperatureRecord.getTime_hour_10_temperature());
        jsonObject.put("time_hour_14_temperature", temperatureRecord.getTime_hour_14_temperature());
        jsonObject.put("time_hour_18_temperature", temperatureRecord.getTime_hour_18_temperature());
        jsonObject.put("time_hour_22_temperature", temperatureRecord.getTime_hour_22_temperature());
